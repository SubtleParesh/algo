...
ENDPOINT="${8:-${ENDPOINT:-0.0.0.0}}"
USERS="${9:-${USERS:-homeserver,homewindows,worklaptop,oneplus7,edward,alphonse,simba,hermione,pikachu,wolverine,merlin,mario,cloud,yoda,alice,loki}}"
REPO_SLUG="${10:-${REPO_SLUG:-SubtleParesh/algo}}"
